...
\chapter{Lesson 8 - I2C Sensors (Temperature, Humidity, Pressure and Acellerometer)}\chapter{Lesson 9 - Ultrasonic Sensor (Distance)}\chapter{Lesson 10 - LCD Display}\chapter{Lesson 11 - Build a Mini Weather Station}
